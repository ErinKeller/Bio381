### Emily Mikucki Presentation - Animation
### 19 April 2017
### ELk
...
# interval = 0.3 will speed up the animation
oopt = ani.options(interval = 0.3, nmax = ifelse(interactive(), #if else(interactive() meaning assumed human operator that dictate some of these parameters
                                                 50, 2))
